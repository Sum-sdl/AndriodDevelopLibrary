...
public class CharacterParserUtils {
    ...
    private static String[] pystr = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
            "biao", "bie", "bin", "bing", "bo", "bu", "BaseDynamicInterceptor", "cai", "can", "cang", "cao", "ce", "ceng", "cha", "chai", "chan", "chang", "chao", "che",
     ...
     * 单字解析
     */
    public String convertSingle(String str) {
        String result = null;
     ...
     * 词组解析
     */
    public String convertGroup(String chs) {
        String key, value;
