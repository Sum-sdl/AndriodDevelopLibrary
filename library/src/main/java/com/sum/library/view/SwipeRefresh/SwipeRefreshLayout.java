...
package com.sum.library.view.SwipeRefresh;
 ...
 * not be a refresh, it must call setRefreshing(false) to dialog_cancel any visual
...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private static final int REFRESH_TRIGGER_DISTANCE = 75;
