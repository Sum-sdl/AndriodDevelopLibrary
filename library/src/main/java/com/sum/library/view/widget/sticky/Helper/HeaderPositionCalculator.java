...
public class HeaderPositionCalculator {
    ...
    public void initHeaderBounds(Rect bounds, RecyclerView recyclerView, View header, View firstView, boolean firstHeader) {
        ...
        //存在第一个头部View，有两个HeadView，两个HeadView是否位移到一起
...
//            Logger.e("firstViewUnderHeaderPosition: "+firstViewUnderHeaderPosition);
    ...
    private void initDefaultHeaderOffset(Rect headerMargins, RecyclerView recyclerView, View header, View firstView, int orientation) {
        ...
        if (orientation == LinearLayoutManager.VERTICAL) {
            ...
            //设置headView所在Rect的Y方向上的距离，最小的第一个View距离其顶部的位置
...
//                Logger.e("topOfNextHeader:"+topOfNextHeader+" bottomOfThisHeader:"+bottomOfThisHeader);
            } else {
...
//            Logger.e(" topOfStickyHeader:" + topOfStickyHeader + " shiftFromNextHeader:" + shiftFromNextHeader + " translation.top:" + translation.top+" "+translation.hashCode());
        } else {
